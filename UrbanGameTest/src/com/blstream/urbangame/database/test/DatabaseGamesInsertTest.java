...
public class DatabaseGamesInsertTest extends AndroidTestCase {
	...
	protected void setUp() throws Exception {
		...
		game = new UrbanGame(3L, 2.4, "title", "Operator Name", "winningStrategy", 34, 50, startDate, endDate, 2, true,
			"prizesInfo", "description", "gameLogoBase64", "operatorLogoBase64", "comments", "location", "detaisLink");
		gameShort = new UrbanGameShortInfo(3L, "title", "operatorName", 2, 50, startDate, endDate, true, "location",
