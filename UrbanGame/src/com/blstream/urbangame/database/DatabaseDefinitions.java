...
public class DatabaseDefinitions {
	...
	public static final String LOCATION_TASK_ANSWERS_TABLE_NAME = "locationTaskAnswersTableName";
	...
	public static final String USER_TASKS_SPECIFIC_KEY_SELECTED_ANSWERS = "UTSSelectedAnswers";
	...
	public static final String LOCATION_TASK_ANSWER_KEY_TASK_ID = "TaskAnswerTaskID";
	public static final String LOCATION_TASK_ANSWER_KEY_LOCATION_LATITUDE = "TaskAnswerLocationLatitude";
	public static final String LOCATION_TASK_ANSWER_KEY_LOCATION_LONGITUDE = "TaskAnswerLocationLongitude";
	public static final String LOCATION_TASK_ANSWER_KEY_USER_EMAIL = "TaskAnswerLocationUserEmail";
	public static final String LOCATION_TASK_ANSWER_KEY_DATE = "TaskAnswerDate";
	public static final String LOCATION_TASK_ANSWER_KEY_ID = "TaskAnswerID";
	...
	public static final String CREATE_USER_TASKS_SPECIFIC_TABLE = "CREATE TABLE " + USER_TASKS_SPECIFIC_TABLE_NAME
		...
		+ USER_TASKS_SPECIFIC_KEY_CHANGES + " TEXT, " + USER_TASKS_SPECIFIC_KEY_STATUS + " INTEGER, "
		+ USER_TASKS_SPECIFIC_KEY_SELECTED_ANSWERS + " TEXT, " + "PRIMARY KEY (" + USER_TASKS_SPECIFIC_KEY_PLAYER_EMAIL
		+ ", " + USER_TASKS_SPECIFIC_KEY_TASK_ID + "), " + " FOREIGN KEY (" + USER_TASKS_SPECIFIC_KEY_TASK_ID
		+ ") REFERENCES " + TASKS_TABLE_NAME + " (" + TASKS_KEY_ID + "), " + " FOREIGN KEY ("
		+ USER_TASKS_SPECIFIC_KEY_PLAYER_EMAIL + ") REFERENCES " + USER_TABLE_NAME + " (" + USER_KEY_EMAIL + ") " + ")";
	...
	public static final String CREATE_LOCATION_TASK_ANSWER_TABLE = "CREATE TABLE " + LOCATION_TASK_ANSWERS_TABLE_NAME
