...
public class UrbanGame {
	 ...
	 * @param detailsLink
	 */
	public UrbanGame(Long iD, Double gameVersion, String title,
			String operatorName, String winningStrategy, Integer players,
			Integer maxPlayers, Date startDate, Date endDate,
			Integer difficulty, Boolean reward, String prizesInfo,
			String description, String gameLogoBase64,
			String operatorLogoBase64, String comments, String location,
			String detailsLink) {
		this(gameVersion, title, operatorName, winningStrategy, players,
				maxPlayers, startDate, endDate, difficulty, reward, prizesInfo,
				description, gameLogoBase64, operatorLogoBase64, comments,
	 ...
	 * @param comments
	 */
	public UrbanGame(Double gameVersion, String title, String operatorName,
			String winningStrategy, Integer players, Integer maxPlayers,
			Date startDate, Date endDate, Integer difficulty, Boolean reward,
			String prizesInfo, String description, String gameLogoBase64,
			String operatorLogoBase64, String comments, String location,
			String detailsLink) {
	...
	/**
	 * @param res
	 *            - can be obtained by getResource() invoked in Activity
