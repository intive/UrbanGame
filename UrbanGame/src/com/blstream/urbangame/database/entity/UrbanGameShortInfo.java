...
public class UrbanGameShortInfo {
	 ...
	 * @param reward
	 * @param location
	 * @param logoBase64 - encoded in base 64 format (it comes in web server
	 * response
	 * @param detailsLink */
	public UrbanGameShortInfo(String title, String operatorName, Integer players, Integer maxPlayers, Date startDate,
		Date endDate, Boolean reward, String location, String gameLogoBase64, String operatorLogoBase64,
		String detailsLink) {
		this.title = title;
	 ...
	 * @param reward
	 * @param location
	 * @param gamelogoBase64 - encoded in base 64 format (it comes in web server
	 * response
	 * @param operatorlogoBase64 - encoded in base 64 format (it comes in web
	 * server response
	 * @param detailsLink */
	public UrbanGameShortInfo(Long ID, String title, String operatorName, Integer players, Integer maxPlayers,
		Date startDate, Date endDate, Boolean reward, String location, String gameLogoBase64,
		String operatorLogoBase64, String detailsLink) {
		this(title, operatorName, players, maxPlayers, startDate, endDate, reward, location, gameLogoBase64,
	 ...
	 * @param startDate
	 * @param endDate
	 * @param logoDrawable - drawable format */
	@Deprecated
	public UrbanGameShortInfo(String title, String operatorName, Integer players, Integer maxPlayers, Date startDate,
		Date endDate, Boolean reward, String location, Drawable logoDrawable, Drawable operatorLogoDrawable) {
		this.title = title;
		this.operatorName = operatorName;
		this.players = players;
		this.maxPlayers = maxPlayers;
	...
	public Drawable getGameLogoDrawable(Resources res) {
		if (gameLogoDrawable == null && gameLogoBase64 != null) {
			gameLogoDrawable = Base64ImageCoder.decodeImage(gameLogoBase64, res);
		}
	...
	public Drawable getOperatorLogoDrawable(Resources res) {
		if (operatorLogoDrawable == null && operatorLogoBase64 != null) {
			operatorLogoDrawable = Base64ImageCoder.decodeImage(operatorLogoBase64, res);
		}
	...
	public boolean equals(Object object) {
		...
		UrbanGameShortInfo urbanGameShortinfo = (UrbanGameShortInfo) object;
		
		if (getDetailsLink().equals(urbanGameShortinfo.getDetailsLink())
			&& getEndDate().equals(urbanGameShortinfo.getEndDate())
			&& getLocation().equals(urbanGameShortinfo.getLocation())
			&& getMaxPlayers().equals(urbanGameShortinfo.getMaxPlayers())
			&& getOperatorName().equals(urbanGameShortinfo.getOperatorName())
			&& getPlayers().equals(urbanGameShortinfo.getPlayers())
			&& getReward().equals(urbanGameShortinfo.getReward())
			&& getStartDate().equals(urbanGameShortinfo.getStartDate())
			&& getTitle().equals(urbanGameShortinfo.getTitle())) return true;
