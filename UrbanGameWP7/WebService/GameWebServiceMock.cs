...
namespace WebService
{
    public class GameWebServiceMock:IGameWebService
    {
        ...
        {
            return new IGame[] {
                new GameMock(){Name = "M For The Mission", GameType = GameType.Race, GameState = GameState.Joined, Id = 1, OperatorLogo = "/ApplicationIcon.png", GameEnd = DateTime.Now.AddDays(2).AddHours(13), Rank = 4},
                new GameMock(){Name = "Thanks For All That Fish", GameType = GameType.Quiz, GameState = GameState.Joined, Id = 2, OperatorLogo = "/ApplicationIcon.png", GameEnd = DateTime.Now.AddDays(3).AddHours(5), Rank = null},
                new GameMock(){Name = "Pontifex", GameType = GameType.Race, GameState = GameState.Joined, Id = 3, OperatorLogo = "/ApplicationIcon.png", GameEnd = DateTime.Now.AddDays(8), Rank = 8}};
        }
        #endregion
        ...
        {
            return new IGame[] {
                new GameMock(){Name = "Hydromystery", GameType = GameType.Quiz, OperatorName = "Cafeteria", NumberOfPlayers = 23, NumberOfSlots = 48, Id = 4, OperatorLogo = "/ApplicationIcon.png", GameStart = new DateTime(2013, 4, 8, 12, 12,0) ,GameEnd = DateTime.Now.AddDays(2).AddHours(10), GameState = GameState.None, Difficulty = GameDifficulty.Easy, Description = "Le 10 septembre 2008, quelques jours après avoir fêté son vingtième anniversaire, Lewandowski débute sa carrière internationale avec la Pologne face à Saint-Marin, lors des éliminatoires de la coupe du monde 2010."},
                new GameMock(){Name = "North & South", GameType = GameType.Race, OperatorName = "Infogrames", NumberOfPlayers = 23, Id = 5, OperatorLogo = "/ApplicationIcon.png", GameEnd = DateTime.Now.AddDays(3).AddHours(12), GameState = GameState.None},
                new GameMock(){Name = "Ultimate Quest", GameType = GameType.Quiz,  OperatorName = "JCVD", NumberOfPlayers = 23,Id = 6, OperatorLogo = "/ApplicationIcon.png",  GameEnd = DateTime.Now.AddDays(10), GameState = GameState.None},
                new GameMock(){Name = "Galaxy Quest", GameType = GameType.Race,  OperatorName = "NSEA", NumberOfPlayers = 23,Id = 7, OperatorLogo = "/ApplicationIcon.png", GameStart = new DateTime(2013,4,10,8,12,0), GameState = GameState.None},
                new GameMock(){Name = "The Quest for NEETs", GameType = GameType.Race,  OperatorName = "Ron Jeremy", NumberOfPlayers = 23,Id = 8, OperatorLogo = "/ApplicationIcon.png", GameStart = new DateTime(2013,5,9,21,5,8), GameState = GameState.None}};
        }
        #endregion
