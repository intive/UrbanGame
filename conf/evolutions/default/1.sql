...
create table "GPSTASKS" ("gameId" INTEGER NOT NULL,"taskId" INTEGER NOT NULL,"lat" DOUBLE NOT NULL,"lon" DOUBLE NOT NULL,"range" DOUBLE NOT NULL,"points" INTEGER NOT NULL);
...
create table "USERGAMES" ("userId" INTEGER NOT NULL,"gameId" INTEGER NOT NULL,"joined" TIMESTAMP DEFAULT {ts '2013-07-03 02:52:26.726'} NOT NULL,"left" TIMESTAMP,"points" INTEGER DEFAULT 0 NOT NULL);
