...
create table "USERGAMES" ("userId" INTEGER NOT NULL,"gameId" INTEGER NOT NULL,"joined" TIMESTAMP DEFAULT {ts '2013-07-04 18:15:35.534'} NOT NULL,"left" TIMESTAMP,"points" INTEGER DEFAULT 0 NOT NULL);
