...
create table "GPSTASKS" ("gameId" INTEGER NOT NULL,"taskId" INTEGER NOT NULL,"pointId" INTEGER NOT NULL,"lat" DOUBLE NOT NULL,"lon" DOUBLE NOT NULL,"range" DOUBLE NOT NULL);
...
create table "TASKS" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,"gameId" INTEGER NOT NULL,"version" INTEGER DEFAULT 1 NOT NULL,"type" VARCHAR NOT NULL,"name" VARCHAR NOT NULL,"description" VARCHAR NOT NULL,"maxpoints" INTEGER NOT NULL,"minToAccept" INTEGER DEFAULT 1 NOT NULL,"maxattempts" INTEGER NOT NULL,"timeLimit" TIMESTAMP,"lat" DOUBLE,"lon" DOUBLE,"rangeLimit" DOUBLE,"active" BOOLEAN DEFAULT true NOT NULL,"penalty" INTEGER DEFAULT 0 NOT NULL);
...
create table "USERGAMES" ("userId" INTEGER NOT NULL,"gameId" INTEGER NOT NULL,"joined" TIMESTAMP DEFAULT {ts '2013-07-03 15:54:18.859'} NOT NULL,"left" TIMESTAMP,"points" INTEGER DEFAULT 0 NOT NULL);
