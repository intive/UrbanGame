...
create table "USERGAMES" ("userId" INTEGER NOT NULL,"gameId" INTEGER NOT NULL,"joined" TIMESTAMP DEFAULT {ts '2013-07-03 17:00:43.842'} NOT NULL,"left" TIMESTAMP,"points" INTEGER DEFAULT 0 NOT NULL);
