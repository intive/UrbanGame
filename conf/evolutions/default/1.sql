...
create table "GAMES" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"version" INTEGER DEFAULT 1 NOT NULL,"description" VARCHAR NOT NULL,"location" VARCHAR NOT NULL,"operatorId" INTEGER NOT NULL,"created" TIMESTAMP DEFAULT {ts '2013-05-06 11:50:38.654'} NOT NULL,"startTime" TIMESTAMP DEFAULT {ts '2013-05-06 11:50:38.654'} NOT NULL,"endTime" TIMESTAMP NOT NULL,"started" TIMESTAMP DEFAULT {ts '2013-05-06 11:50:38.654'} NOT NULL,"ended" TIMESTAMP NOT NULL,"winning" VARCHAR DEFAULT 'max_points' NOT NULL,"nWins" INTEGER DEFAULT 1 NOT NULL,"difficulty" VARCHAR DEFAULT 'easy' NOT NULL,"maxPlayers" INTEGER DEFAULT 1000000 NOT NULL,"awards" VARCHAR NOT NULL,"status" VARCHAR DEFAULT 'project' NOT NULL);
